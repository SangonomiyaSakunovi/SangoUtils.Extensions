...
namespace SangoUtils.Converters.Mapping
{
    internal static class NumberMapSango
    {
        internal static int GetNumberConvertProtocol_ASCII_A0a26(char inputChar)
        {
        ...
        internal static char GetCharConvertProtocol_ASCII_A0a26(int inputNum)
        {
