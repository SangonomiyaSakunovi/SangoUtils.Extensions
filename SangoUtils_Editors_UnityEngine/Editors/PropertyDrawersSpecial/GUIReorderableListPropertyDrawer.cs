...
namespace SangoUtils.Editors_Unity
{
    ...
    {
        public static readonly GUIReorderableListPropertyDrawer Instance = new GUIReorderableListPropertyDrawer();
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            {
                string message = typeof(GUIReordListAttribute).Name + " can be used only on arrays or lists";
                GUIDrawerInspectorEditorUtils.HelpBox_Layout(message, MessageType.Warning, context: property.serializedObject.targetObject);
        ...
        {
            System.Type listType = GUIDrawerPropertyUtils.GetPropertyType(list.serializedProperty);
            System.Type elementType = GUIDrawerReflectionUtils.GetListElementType(listType);
