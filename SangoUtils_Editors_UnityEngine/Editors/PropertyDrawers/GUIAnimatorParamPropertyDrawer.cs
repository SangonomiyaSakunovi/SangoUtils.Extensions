...
namespace SangoUtils.Editors_Unity
{
    ...
    public class GUIAnimatorParamPropertyDrawer : BaseGUIPropertyDrawer
    {
        ...
        {
            GUIAnimatorParamAttribute animatorParamAttribute = GUIDrawerPropertyUtils.GetAttribute<GUIAnimatorParamAttribute>(property);
        ...
        private static AnimatorController GetAnimatorController(SerializedProperty property, string animatorName)
        {
            ...
            FieldInfo animatorFieldInfo = GUIDrawerReflectionUtils.GetField(target, animatorName);
            ...
            PropertyInfo animatorPropertyInfo = GUIDrawerReflectionUtils.GetProperty(target, animatorName);
            ...
            MethodInfo animatorGetterMethodInfo = GUIDrawerReflectionUtils.GetMethod(target, animatorName);
