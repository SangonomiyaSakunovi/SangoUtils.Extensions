...
{
    [CustomPropertyDrawer(typeof(GUIExpandableAttribute))]
    public class GUIExpandablePropertyDrawer : BaseGUIPropertyDrawer
    {
        protected override float GetPropertyHeight_Internal(SerializedProperty property, GUIContent label)
        {
            ...
            System.Type propertyType = GUIDrawerPropertyUtils.GetPropertyType(property);
                        ...
                        using (var iterator = serializedObject.GetIterator())
                        {
                            if (iterator.NextVisible(true))
                            {
                                do
                                {
                                    ...
                                    bool visible = GUIDrawerPropertyUtils.IsVisible(childProperty);
                                    if (!visible)
                                    {
                                        continue;
                                    }
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            else
            {
                ...
                {
                    string message = $"{typeof(GUIExpandableAttribute).Name} can only be used on scriptable objects";
                ...
                using (var iterator = serializedObject.GetIterator())
                {
                    ...
                    if (iterator.NextVisible(true))
                    {
                        do
                        {
                            ...
                            GUIDrawerInspectorEditorUtils.PropertyField(childRect, childProperty, true);
