...
{
    [CustomPropertyDrawer(typeof(GUIShowAssetsAttribute))]
    public class GUIShowAssetPreviewPropertyDrawer : BaseGUIPropertyDrawer
    {
        ...
        protected override void OnGUI_Internal(Rect rect, SerializedProperty property, GUIContent label)
        {
            ...
            if (property.propertyType == SerializedPropertyType.ObjectReference)
            {
                ...
                if (previewTexture != null)
                {
                    ...
                    {
                        x = rect.x + GUIDrawerInspectorEditorUtils.GetIndentLength(rect),
        ...
        private Vector2 GetAssetPreviewSize(SerializedProperty property)
        {
            ...
            {
                int targetWidth = GUIShowAssetsAttribute.DefaultWidth;
                int targetHeight = GUIShowAssetsAttribute.DefaultHeight;

                GUIShowAssetsAttribute showAssetPreviewAttribute = GUIDrawerPropertyUtils.GetAttribute<GUIShowAssetsAttribute>(property);
