...
{
    internal static class GUIDrawerPropertyUtils
    {
        ...
        {
            FieldInfo fieldInfo = GUIDrawerReflectionUtils.GetField(GetTargetObjectWithProperty(property), property.name);
            if (fieldInfo == null)
            {
                return new T[] { };
            }
        ...
        public static void CallOnValueChangedCallbacks(SerializedProperty property)
        {
            ...
            {
                MethodInfo callbackMethod = GUIDrawerReflectionUtils.GetMethod(target, onValueChangedAttribute.CallbackName);
        ...
        {
            FieldInfo enumField = GUIDrawerReflectionUtils.GetField(target, enumName);
            if (enumField != null && enumField.FieldType.IsSubclassOf(typeof(Enum)))
            {
                return (Enum)enumField.GetValue(target);
            }

            PropertyInfo enumProperty = GUIDrawerReflectionUtils.GetProperty(target, enumName);
            if (enumProperty != null && enumProperty.PropertyType.IsSubclassOf(typeof(Enum)))
            {
                return (Enum)enumProperty.GetValue(target);
            }

            MethodInfo enumMethod = GUIDrawerReflectionUtils.GetMethod(target, enumName);
        ...
        internal static List<bool> GetConditionValues(object target, string[] conditions)
        {
            ...
            {
                FieldInfo conditionField = GUIDrawerReflectionUtils.GetField(target, condition);
                ...
                PropertyInfo conditionProperty = GUIDrawerReflectionUtils.GetProperty(target, condition);
                ...
                MethodInfo conditionMethod = GUIDrawerReflectionUtils.GetMethod(target, condition);
