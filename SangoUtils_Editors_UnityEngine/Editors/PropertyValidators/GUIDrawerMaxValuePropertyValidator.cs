...
{
    internal class GUIDrawerMaxValuePropertyValidator : BaseGUIDrawerPropertyValidator
    {
        public override void ValidateProperty(SerializedProperty property)
        {
            GUIMaxValueAttribute maxValueAttribute = GUIDrawerPropertyUtils.GetAttribute<GUIMaxValueAttribute>(property);
