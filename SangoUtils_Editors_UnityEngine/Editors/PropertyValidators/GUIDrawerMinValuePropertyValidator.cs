...
{
    internal class GUIDrawerMinValuePropertyValidator : BaseGUIDrawerPropertyValidator
    {
        public override void ValidateProperty(SerializedProperty property)
        {
            GUIMinValueAttribute minValueAttribute = GUIDrawerPropertyUtils.GetAttribute<GUIMinValueAttribute>(property);
