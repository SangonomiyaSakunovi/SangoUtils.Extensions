...
namespace SangoUtils.WebRequests_Unity
{
    ...
    public abstract class UnityWebResourceBasePack
    {
        public uint PackId { get; set; }

        public string Url { get; set; }
        public int TryCount { get; set; }
        public UnityWebResourceType ResourceType { get; set; }
    ...
    public class UnityWebResourceRawImagePack : UnityWebResourceBasePack
    {
